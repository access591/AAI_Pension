...
function low(obj) {
  ...
  <tr>
   		<td>
   		  ...
   		  <tr>
        <td colspan="2"></td>
        <td colspan="4">Summarized Control account <%=dispYear%></td>
        <td colspan="2"></td> 
       
        
      <tr>
        <td align="center" class="label" >AAI EPF-11</td>
	 ...
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_frmType=form2summary&frm_status=<%=empStatus%>&frm_region=NO-SELECT&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotAdjEmpSubscription)%></a></td> 
	 <td width="8%" class="NumData">&nbsp;</td>
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_frmType=form8summary&frm_status=<%=empStatus%>&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotadvanceAmt+grandTotEmpLoanAmt)%></a></td>
	 <td width="8%" class="NumData">&nbsp;</td>
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_frmType=form8summary&frm_status=<%=empStatus%>&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotFinEmpAmt)%></a></td> 
	 <td width="8%" class="NumData">&nbsp;</td>	 
	 </tr>
	 <tr>
	...
	<td width="8%" class="NumData"><%=df1.format(EMPClosingBalTot_diff)%></td>
	 ...
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_status=<%=empStatus%>&frm_frmType=form2summary&frm_region=NO-SELECT&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotAdjContri)%></a></td> 
	 <td width="8%" class="NumData">&nbsp;</td>
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_status=<%=empStatus%>&frm_frmType=form8summary&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotAAILoanAmt)%></a></td>
	 <td width="8%" class="NumData">&nbsp;</td>
	 <td width="8%" class="NumData"><a  title="Click the link to view Transaction log" target="new" href="./aaiepfreportservlet?method=getsummaryinformation&frm_status=<%=empStatus%>&frm_frmType=form8summary&frm_finyear=<%=dispYear%>"><%=df1.format(grandTotPensoinContri-grandTotFinAAIAmt)%></a></td> 
	 <td width="8%" class="NumData">&nbsp;</td>	  
	 </tr>
