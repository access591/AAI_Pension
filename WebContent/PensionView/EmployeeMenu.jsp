                ...
                <tr>
                  ...
                  <td width="8%" align="right" valign="middle"><table width="60" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="center" valign="middle"><a href="#"><img src="<%=basePath%>PensionView/images/home.gif" title="Home" width="16" height="16" border="0" /></a></td>

                      <td align="right" valign="middle"><a href="<%=basePath%>PensionLogin?method=elogoff" target="_parent"><img src="<%=basePath%>PensionView/images/logout.gif" title="Logout" width="14" height="16" border="0" /></a></td>
                    </tr>
                  </table></td>
  ...
  <tr>
    <td height="100%" align="center" valign="middle" class="BodyContentMagins" >
      ...
      <tr>
        ...
        <td width="157" align="center" valign="top" background="<%=basePath%>PensionView/images/menu2.png" class="MenuPadding">
        <table width="128" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr>
            <td align="center" valign="middle" class="dots"><a href="<%=basePath%>reportservlet?method=loadpfcardInput" > <font color="blue"> PF Card </font></a></td>
          </tr>
