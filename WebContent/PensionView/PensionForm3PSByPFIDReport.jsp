					...
					<td>
						<table width="100%" border="1" bordercolor="gray" cellpadding="2" cellspacing="0">
							...
							<tr>
								...
								<td class="label" >FreshPensionoption</td>
								<td class="label" >Remarks</td>
								<td class="label" >New EmpCode</td>
						...
						<tr>
							...
							<td class="Data" width="15%">
								...
								<td class="Data" width="15%">
									<%=formsetBean.getFreshPensionOption()%>
								</td>
								<td class="Data" width="15%">
									<%=formsetBean.getRemarks()%>
								</td>
									<td class="Data" width="15%">
									<%=formsetBean.getNewEmployeeNumber()%>
								</td>
									<td class="Data" width="15%">
									<%=formsetBean.getUanno()%>
								</td>
								 <td class="Data" width="15%">
