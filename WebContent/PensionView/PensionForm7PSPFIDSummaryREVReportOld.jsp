...
<html>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
							...
							if(pensionDataList.size()!=0){
    							...
    							for(int j=0;j<pensionDataList.size();j++){
									    ...
									    if(seperationMnth.equals(monthYear)){
									     System.out.println("finalRemarks::::::prasanthi::::::::==============.......;"+"finalRemarks"+finalRemarks+"====form7NarrationRemarks====="+form7NarrationRemarks+"===remarks==="+remarks);
      ...
      System.out.println("finalRemarks===="+finalRemarks+"arrearRemarks"+arrearRemarks);
      ...
      System.out.println("displyMnthYear===="+displyMnthYear+"totalFpfFund"+totalFpfFund+finalRemarks);
  ...
  <tr>
    <td colspan="4"><table width="95%" border="1" bordercolor="gray" cellpadding="2" cellspacing="0" align="center">
      ...
      double grandDuePensionContr=0.0,grandEmoluments=0.0;
        ...
        System.out.println("===dispFinalremarks=="+finalYearDataStr[3]+"===="+finalYearDataStr[4]+finalYearDataStr[5]+finalYearDataStr[7]);
      %>
    <tr>
