...
<script type="text/javascript">
 ...
 function LoadWindow(params){
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet?method=executive";
	...
	function validateForm() {
		var regionID="",airportcode="",params="",sortingOrder="",empName="",reportType="",url="",yearID="",monthID="",yearDesc="",formType="",toYearID="";
	...
	if(reportType=='[Select One]'){
		...
		url="<%=basePath%>aaiepfreportservlet?method=executivereport"+params;
	...
	function frmload(){
		 process.style.display="none";
		 document.forms[0].select_from_month.value="05";
		 document.forms[0].select_to_month.value="04";
	}
...
<table width="75%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<td><SELECT NAME="select_sorting" style="width: 88px">
			...
			<option value="pensionno,monthyear">PFID</option>
			<option value="emp_level">Emp Level</option>
			<option value="monthyear">Sal month</option>
