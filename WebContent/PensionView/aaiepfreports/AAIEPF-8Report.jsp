...
<%@ page import="aims.bean.epfforms.AAIEPFReportBean"%>
...
<table width="1343" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table cellspacing="0" cellpadding="0">
      <tr>
        <td height="24" colspan="8" width="900" align="center"> <img src="<%=basePath%>PensionView/images/logoani.gif"  width="75" height="55" align="right" /></td>
      </tr>
    </table>
