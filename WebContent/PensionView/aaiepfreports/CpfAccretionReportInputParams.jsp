...
<%String path = request.getContextPath();
            String basePath = request.getScheme() + "://"
                    ...
                    String[] year = {"2008-09","2009-10","2010-11","2011-12","2012-13","2013-14","2014-15","2015-16"};
                    String[] userYears = {"2008-09","2009-10","2010-11","2011-12","2012-13","2013-14","2014-15","2015-16"};		
...
<html>
 ...
 function LoadWindow(params){
	...
	winHandle = window.open(newParams,"CPFAccretion","menubar=yes,toolbar = yes,scrollbars=yes,resizable=yes");
	winOpened = true;
	...
	function resetReportParams(){
		document.forms[0].action="<%=basePath%>aaiepfreportservlet?method=loadcpfAccretion";
			...
			<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				<tr>
					<td height="5%" colspan="2" align="center" class="ScreenMasterHeading">
						 CPF Accretion Report Input Params
					</td>
				</tr>
				<tr>
					<td>
