...
// System.out.println("after month "+month +"after year "+year);
 String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
    ...
    String region="",empsrlNo="",dataFlag="",message="", accessCode="",verifiedby="",userType="",processedStage="",chkPfidTracking="",userId="",blockedYears="";
  	String adjObYears="";
 ...
 if(request.getAttribute("blockedYears")!=null){
   blockedYears=(String)request.getAttribute("blockedYears");
	...
	System.out.println("==verifiedby==="+verifiedby+"=="+request.getAttribute("verifiedby")+"==message==="+message+"==userType=="+userType+"=chkPfidTracking="+chkPfidTracking); 
...
<html>
	...
	function validateForm(empserialNO,employeeName,dojFlag,reportYear,approvedStage) {
       ...
       if(reportYear=="2010-2011"){
        if(!(userId=="navayuga" || userId=="SHIKHA" || userId=="Monika" || userId=="SHIKHAJ" )) {
 ...
 function  getForm2Report(repName,approvedStatus){ 
 	var url="";
 if(approvedStatus!="Approved"){
     alert("This pfid is not Approved.You Cant View Reports");
     return false;
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			if (request.getAttribute("searchInfo") == null) {
				...
				String dateofBirth="",dateofJoining="",empSerailNumber="",totalTrans="",designation = "",pensionOption = "",dojFlag="false";
					...
					%>
							<tr> 
								<td  class="Data" width="15%"><a href="#" onclick="validateForm('<%=empSerailNumber%>','<%=employeeName%>','<%=dojFlag%>','<%=diffBean.getReportYear()%>','<%=diffBean.getApprovedStage()%>')"><img src="./PensionView/images/edit.gif" border="0"   alt="Edit" /></a>
								...
								<%}%>
								 <td  class="Data" width="15%"><a href="#" onclick="getForm2Report('loadForm2','<%=diffBean.getApprovedStage()%>')"><img src="./PensionView/images/form2.gif" border="0"  /></a>
									&nbsp;&nbsp; 
								</td>
