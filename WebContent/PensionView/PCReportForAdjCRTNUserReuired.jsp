...
<%
	...
	String color = "yellow";
	String noofMonths="",arrearFlag="",updateDate="",updateTime="";
	String recoverieTable="";
	 String adjOBYear="1995-2008"; 
	updateDate= (String) request.getAttribute("updatedate");
	updateTime= (String) request.getAttribute("batchtime");
				  ...
				  <td >&nbsp;</td>
				   <td  >&nbsp;</td>
					...
					<td align="center" >
						<table border=0 cellpadding=3 cellspacing=0 width="40%" align="center" valign="middle">
							<tr>
						 	   <td   class="reportlabel" style="text-decoration: underline" align="center" nowrap="nowrap"><%=heading%> </td> 
								 
							</tr>
						
						</table>
					</td>
					<td     class="reportlabel"  align="center" nowrap="nowrap"> Date : <%=updateDate%> <%=updateTime%></td>
		...
		<table border="1" style="border-color: gray;" cellpadding="2"
			...
			<%
				  //System.out.println(bean.getRecordCount());
								...
								%>
							  <% 
							   if(!bean.getEditedDate().trim().equals("N")){%>  
          			<tr bgcolor="orange" >
 			 <%
 			 }else{ %>
  			<tr bgcolor="white">
  ...
  <input type="hidden" name="status" >
	...
	<tr>
	 ...
	 <tr>
	 	...
	 	<font size="2"> <b> Note : This PC Report is generated based on your Group Selection </b> </font>
	 	</td>
				</table>
	 	</td>
	 </tr>
