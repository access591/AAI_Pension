						...
						<TABLE WIDTH="75%" BORDER="0" ALIGN="center" CELLPADDING="0" CELLSPACING="0" CLASS="tbborder">
							...
							<TR>
								<TD HEIGHT="15%">
									<TABLE ALIGN="center">
										<TD CLASS="label">
											Party Name:<FONT COLOR="red">&nbsp;*</FONT>
										</TD>
										<TD>
										...
										<TR>
											...
											<TD>
												<TEXTAREA NAME="partyDetail" MAXLENGTH="150" COLS="20" TABINDEX="17" ROWS=""></TEXTAREA>
											</TD>
										</TR>
										<TR>
											<TD CLASS="label">
											...
											<TD>
												<INPUT TYPE="text" NAME="mobileNo" MAXLENGTH="25" TABINDEX="1">
											</TD>
										</TR>
										<TR>
											<TD CLASS="label">
											...
											<TD>
												<INPUT TYPE="text" NAME="faxNo" MAXLENGTH="25" TABINDEX="1">
											</TD>
										</TR>
										<TR></TR>
										<TR>
											...
											<TD>
												<INPUT TYPE="text" NAME="email" MAXLENGTH="25" TABINDEX="1">
											</TD>
										</TR>
										<TR>
