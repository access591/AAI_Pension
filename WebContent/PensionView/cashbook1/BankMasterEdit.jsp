...
<HTML>
	...
	<BODY CLASS="BodyBackground1" onload="document.forms[0].bankName.focus();">
		<FORM NAME="bank" ACTION="<%=basePathBuf%>BankMaster?method=updateBankRecord" ONSUBMIT="javascript : return checkRecord()" METHOD="post">
								...
								<TD HEIGHT="15%" ALIGN="center">
									<TABLE ALIGN="center" BORDER="0">
										...
										<TR>
											...
											<TD>
												<TEXTAREA NAME="address" MAXLENGTH="150" COLS="20" TABINDEX="17" ROWS="" STYLE='width=130px'><%=bank.getAddress()%></TEXTAREA>
											</TD>
										</TR>
										<TR>
											<TD CLASS="label">
										...
										<TR>
											...
											<TD>
												<INPUT TYPE="text" NAME="accountCode" MAXLENGTH="25" SIZE="15"  value="<%=bank.getAccountCode()%>" READONLY>
												&nbsp;
											...
											<TD>
												<INPUT TYPE="text" NAME="accountNo" MAXLENGTH="25" TABINDEX="2" value="<%=bank.getAccountNo()%>" READONLY>
											</TD>
										</TR>
										<TR>
											<TD CLASS="label">
											...
											<TD>
												<SELECT NAME="accountType" TABINDEX="15" STYLE="Width:130px">
													<OPTION VALUE="S" <%=(bank.getAccountType().trim().equals("S"))?"selected":""%>>
														Saving
													</OPTION>
													<OPTION VALUE='C' <%=(bank.getAccountType().trim().equals("C"))?"selected":""%>>
														Current
													</OPTION>
												</SELECT>
											</TD>
