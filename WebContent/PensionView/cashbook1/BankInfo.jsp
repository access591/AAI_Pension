...
%>
							<tr>
								...
								<td>
								<input type="checkbox" name="accNo" value="<%=info.getAccountNo()%>" onclick="javascript:sendBankInfo('<%=info.getAccountNo()%>','<%=info.getBankName()%>','<%=info.getAccountCode()%>','<%=info.getParticular()%>')" />
								</td>
							</tr>
<%		
	}
