...
<%String path = request.getContextPath();
            String basePath = request.getScheme() + "://"
                    ...
                    String[] year = {"1995-96","1996-97","1997-98","1998-99","1999-00","2000-01","2001-02","2002-03","2003-04","2004-05","2005-06","2006-07","2007-08","2008-09","2009-10","2010-11","2011-12","2012-13","2013-14","2014-15","2015-16"};
 ...
 function LoadWindow(params){
	...
	if( normalForm7psFlag=="true"){
		...
		//if(formType=='FORM-7PS'|| formType=='FORM-78PS-SUMMARY' || formType=='FORM-7PS-SUMMARY' || formType=='FORM-7PS-SUMMARY[REV]' || formType=='FORM-7PS-REVISED'){
			url="<%=basePath%>pcreportservlet?method=form7revionoptionreport"+params;
			...
			<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="tbborder">
				<tr>
					<td height="5%" colspan="2" align="center" class="ScreenMasterHeading">
						 Form-7 Revision Option Report Params
					</td>
				</tr>
				<tr>
					<td>
...
<tr>
				...
				<tr>
					...
					<td width="50%" ><select name='select_formType' style='width:150px' >
						<option value='FORM-7RevisionOption'>FORM-7REVISION OPTION</option>
					</select>
					</td>
				</tr>
				<TR>
