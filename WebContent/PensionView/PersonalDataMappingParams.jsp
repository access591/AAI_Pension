			...
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<td>
					...
					<tr>
						...
						<tr>
						 <td align="right" >
        					<input type="button"  name="Submit" value="Submit" onclick="javascript:validateForm('<%=session.getAttribute("userid")%>')"> 
        					<input type="button"  name="Reset" value="Reset" onclick="javascript:resetReportParams()" >
        					<input type="button"  name="Submit" value="Cancel" onclick="javascript:history.back(-1)" >
       					 </td>
       					 </tr>
                    	<tr>  
     						 <td align="center"></td>  
