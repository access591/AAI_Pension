...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="7"><table width="90%" align="center"  border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="8%" colspan="2" class="label" align="center">Wages</td>
         <td width="3%" rowspan="2" class="label" align="center">Due Emoluments</td>
        <td width="3%" rowspan="2" class="label" align="center">Pension Contribution</td>
        
              <td width="3%" rowspan="2" class="label" align="center">Due Pension amount</td>
      ...
      <tr>
		...
		double grandEmoluments=0.00,grandPension=0.00,grandDueEmoluments=0.00,grandDuepensionamount=0.00;
		double dispTotalEmoluments=0.00,dispTotalPension=0.00,dispDueEmoluments=0.00,dispDuepensionamount=0.00;
		...
		dispDueEmoluments=Math.round(Double.parseDouble(pensionCardInfo.getDueemoluments()));
		dispDuepensionamount=Math.round(Double.parseDouble(pensionCardInfo.getDuepensionamount()));
	...
	//	dispTotalPension=dispTotalPension+Double.parseDouble(pensionCardInfo.getDuepensionamount());
		...
		grandDueEmoluments=grandDueEmoluments+dispDueEmoluments;
		grandDuepensionamount=grandDuepensionamount+dispDuepensionamount;
...
<tr>
	...
	<td align="center" class="Data"><%=dispTotalEmoluments%></td>
		<td align="center" class="Data"><%=dispDueEmoluments%></td>
	<td align="center" class="Data"><%=dispTotalPension%></td>
	
	<td align="center" class="Data"><%=dispDuepensionamount%></td>
...
<tr>
	...
	<td align="center" class="Data" ><%=df1.format(grandDuepensionamount)%></td>
	<td align="center" class="Data" colspan="1">&nbsp;</td>
</tr>
<%}%>
	</table>
	</td>
