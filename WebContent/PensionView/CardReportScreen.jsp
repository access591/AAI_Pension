...
<%
	...
	String cadTrackingStatus = "";
	System.out.println("this is starting...");
	String reIntrestcalcDate = request
			.getAttribute("reIntrestcalcDate").toString();
	System.out.println("reSettlementdate");
	System.out.println("reSettlementdate"
			+ request.getAttribute("resettledate").toString());
	String reSettlementdate = request.getAttribute("resettledate")
			.toString();
	String finalStatus = request.getAttribute("finalizeFlag")
			.toString();

	if (request.getAttribute("finalizeFlag") != null) {
		finalStatus = request.getAttribute("finalizeFlag").toString();
	}
...
function checkdataFreeze(monthyear,region,airportcode){
 ...
 var url="<%=basePath%>CadServlet?method=checkDataFreeze&region="+region+"&airportcode="+airportcode+"&monthyear="+monthyear;
...
var xmlHttp;
  function editEmoluments(monthyear,cpfaccno,region,airportcode,pensionNo,emolumentxtextboxno,vpftextboxno,principletextboxno,interesttextboxno,advancetextboxno,contributionboxno,advanceboxno,loanboxno,aailoanboxno,editid,pfsettled,userId,freezflag,from7narration1,pcheldamt1,noofmonths1,arrearFlag1,duputationflag,epftextboxno,benfundcontrboxno,benfundPensionboxno,gratuityInterestboxno,epfoPensionboxno,addContriboxno){
	...
	var region2= region;
	  ...
	  //  alert(" AA ");
	 var benfundcontr = document.getElementById(benfundcontrboxno).value;	 
	 var benfundPension = document.getElementById(benfundPensionboxno).value;
	 var gratuityInterest = document.getElementById(gratuityInterestboxno).value;
	 var epfoPension = document.getElementById(epfoPensionboxno).value;
	 var addContri = document.getElementById(addContriboxno).value;
	  //  alert(" benfundcontr "+benfundcontr);
	 ...
	 var arrearFlag=document.getElementById(arrearFlag1).value;
	  // alert(" before if "+parseInt(year1));
	 if((parseInt(year1) >= 2014 &&parseInt(month) >= 10 ) ){
	//  alert(" after if "+parseInt(year1));
	 document.getElementsByName(addContriboxno)[0].style.background='#FFFFCC';
	 document.getElementsByName(addContriboxno)[0].readOnly=false;
	}
	 document.getElementsByName(benfundcontrboxno)[0].style.background='#FFFFCC';
	 document.getElementsByName(benfundcontrboxno)[0].readOnly=false;
	 ...
	 document.getElementsByName(epftextboxno)[0].readOnly=false;
	  ...
	  document.getElementsByName(benfundPensionboxno)[0].style.background='#FFFFCC';
	 document.getElementsByName(benfundPensionboxno)[0].readOnly=false;
	 
	  document.getElementsByName(gratuityInterestboxno)[0].style.background='#FFFFCC';
	 document.getElementsByName(gratuityInterestboxno)[0].readOnly=false;
	 
	  document.getElementsByName(gratuityInterestboxno)[0].style.background='#FFFFCC';
	  document.getElementsByName(gratuityInterestboxno)[0].readOnly=false;
	 
	  document.getElementsByName(epfoPensionboxno)[0].style.background='#FFFFCC';
	 document.getElementsByName(epfoPensionboxno)[0].readOnly=false;
	 ...
	 if(arrearFlag=="N" && monthyear=="01-SEP-2009"){
		...
		var url="<%=basePath%>CadServlet?method=editTransactionData&pensionNo="+pensionNo+"&cpfaccno="+cpfaccno1+"&emoluments="+emoluments+"&monthyear="+monthyear+"&region="+region2+"&airportcode="+airportcode+"&editid="+editid+"&vpf="+vpf+"&principle="+principle+"&interest="+interest+"&contri="+contri+"&advance="+advance+"&loan="+loan+"&aailoan="+aailoan+"&from7narration="+from7narration+"&pcheldamt="+pcheldamt+"&noofmonths="+noofmonths+"&arrearflag="+arrearFlag+"&duputationflag="+duputationflag+"&pensionoption="+pensionoption+"&recoverieTable="+recoverieTable+"&epf="+epf+"&benfundcontr="+benfundcontr+"&benfundPension="+benfundPension+"&gratuityInterest="+gratuityInterest+"&epfoPension="+epfoPension+"&addContri="+addContri;
      // alert(url);
  ...
  function updateemoluments()
  {
	...
	var buttonupdate=xmlHttp.responseText;
	 ...
	 var benfundcontrboxno="benfundcontr"+rownum;
	 var epftextboxno = "epf"+rownum;
	 var benfundPensionboxno="benfundPension"+rownum;
	 var gratuityInterestboxno="gratuityInterest"+rownum;
	 var epfoPensionboxno="epfoPension"+rownum;
	 var addContriboxno="addContri"+rownum;
	 ...
	 document.getElementsByName(benfundcontrboxno)[0].readOnly=true;
	 document.getElementsByName(benfundcontrboxno)[0].style.background='none';
	 
	  document.getElementsByName(benfundPensionboxno)[0].readOnly=true;
	 document.getElementsByName(benfundPensionboxno)[0].style.background='none';
	 
	  document.getElementsByName(gratuityInterestboxno)[0].readOnly=true;
	 document.getElementsByName(gratuityInterestboxno)[0].style.background='none';
	 
	  document.getElementsByName(epfoPensionboxno)[0].readOnly=true;
	 document.getElementsByName(epfoPensionboxno)[0].style.background='none';
	 
	  document.getElementsByName(addContriboxno)[0].readOnly=true;
	 document.getElementsByName(addContriboxno)[0].style.background='none';
	// Refresh();
	}	
  }
	 ...
	 function Approved() {	
 		 ...
 		 // alert(pfid);
 		 var url="<%=basePath%>CadServlet?method=financeDataSearch&pfid="+pfid+"&allRecordsFlag="+allRecordsFlag+"&apStatus=Approved";
 		  // alert(" url======= "+url);
    ...
    function Finalized() { 
    var result = confirm(" Once you have done Finalize, you don't have to Data Edit Permission. Do you want to Proceed ? ");
		if (result) { 	
		...
		var finalflag='Yes';	
		var page = "CardReportScreen";
		var params = "&frm_region="+regionID+"&frm_airportcode="+airportcode+"&frm_year="+yearID+"&frm_month="+monthID+"&frm_reportType="+reportType+"&frm_formType"+formType+"&empserialNO="+empserialNO+"&frm_pfids="+pfidStrip+"&transferStatus="+transferStatus+"&finalrecoverytableFlag="+recoverieTable+"&final_data="+finalflag+"&page="+page;
		var url="<%=basePath%>CadServlet?method=getReportPenContr"+params;		 
		// alert(url);
  ...
  function createXMLHttpRequest()
   ...
   var mappingFlag="true";
	if(answer){
  	document.forms[0].action="<%=basePath%>cadservlet?method=deleteTransactionData&page="+page;
   	document.forms[0].method="post";
  	alert("You dont have the Previliges to Delete the Record");
  	//document.forms[0].submit();
      }
  ...
  {	createXMLHttpRequest();	
    var emoluments= document.getElementById(emolumentsbox).value;
   	var url ="<%=basePath%>CadServlet?method=getContribution&monthyear="+monthyear+"&emoluments="+emoluments+"&dob="+dob+"&wetheroption="+wetheroption+"&contributionbox="+contributionbox;
  	xmlHttp.open("post", url, true);
  ...
  document.forms[0].editdate.value="S";
	 document.forms[0].finalsettle.style.background='#FFFFCC';
		 ...
		 if(buttonName=="S"){ 
	 	 ...
	 	 var url="<%=basePath%>CadServlet?method=editFinalDate&pensionNo="+pensionNo+"&finalsettlementDate="+finalsettledate;
	     xmlHttp.open("post", url, true);
	  ...
	  var recoverieTable='<%=recoverieTable%>';
        ...
        alert("Please ensure that Final Settlement Date "+interestCalcdate+" is less than or equal to current month");
         ...
         return false;
	 	 ...
	 	 var url="<%=basePath%>CadServlet?method=editInterestCalcuptoDate&pensionNo="+pensionNo+"&interestCalcdate="+interestCalcdate+"&recoverieTable="+recoverieTable;
            xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = updateButtonStatus;
			xmlHttp.send(null);
		 }
    ...
    function editReInterestupto(pensionNo,editdate){
	  ...
	  createXMLHttpRequest();
       ...
       return false;
          ...
          var url="<%=basePath%>CadServlet?method=editReInterestcalcupto&pensionNo="+pensionNo+"&reinterestCalcdate="+reinterestCalcdate+"&recoverieTable="+recoverieTable;
             //alert(url);
	        xmlHttp.open("post", url, true);
 ...
 var yearID="NO-SELECT";
 var page="PensionContributionScreen";
 var url="<%=basePath%>CadServlet?method=getReportPenContr&empserialNO=<%=empSerialNo%>&frm_year="+yearID+"&page="+page;
			 alert(" url "+url );
...
<table width="100%" border="0" align="center" cellpadding="0"
	...
	<%
						if (finalStatus.equals("Yes")) {
							CadService cs = new CadService();
							System.out
									.println(" cad_tracking ================================== ");
							approvedby = (String) session.getAttribute("userid");
							status = "Initial";
							System.out.println(" approvedby " + approvedby);
							cs.cadtracking(empSerialNo, status, approvedby);
							System.out
									.println("insert cad_tracking call ================nnnnnnnnn==================");

						}
					%>
	<%
		cadTrackingStatus = cadservice
					.getCadTrackingStatus(empSerialNo);
			System.out.println(" cadTrackingStatus " + cadTrackingStatus);
			if (cadTrackingStatus.equals("Initial")) {
	%>			
		
		<tr><td style="right:0px !important; margin-left: 90#" colspan="30" align="right">
		<div style="padding-left: 95%!important"><input type="button" style = "height: 23px;	width: 68px; border: 1px none #333333;font-family: Arial, Helvetica, sans-serif;	font-size: 12px;	font-weight: bold;	color: #000000;"
						value=" Approve" class="btn" onclick="Approved()"/> </div> </td></tr>	
		<%
				} else if (cadTrackingStatus.equals("")) {
			%>
		<tr><td style="right:0px !important; margin-left: 90#" colspan="30" align="right">
		<div style="padding-left: 90%!important"><input type="button" style = "height: 23px;	width: 68px; border: 1px none #333333;font-family: Arial, Helvetica, sans-serif;	font-size: 12px;	font-weight: bold;	color: #000000;"
						value="  Finalize" class="btn" onclick="Finalized()"/> </div> </td>
						<td style="right:0px !important; margin-right: 10#" colspan="30" align="right">
		<div style="padding-left: 10%!important"><input type="button" style = "height: 23px;	width: 68px; border: 1px none #333333;font-family: Arial, Helvetica, sans-serif;	font-size: 12px;	font-weight: bold;	color: #000000;"
						value="update" class="btn" onclick="location.reload()"/> </div> </td>
						 </tr>
		<%
			}
		%> 
...
<SPAN class="label">Processing.......</SPAN>
		...
		<table border="1" style="border-color: gray;" cellpadding="2"
			...
			<tr> 
				...
				<td class="label" width="8%" align="center">Additional Contri</td>					
				<td class="label" width="6%" align="center">Pension
				Contribution<br>
				(1.16%X2)&8.33%</td>
				<td class="label" width="8%" align="center">NET EPF</td>
				<td class="label" width="8%" align="center">Benevolent Fund Contri</td>
				
				<td class="label" width="8%" align="center">Benevolent Fund pension</td>
				<td class="label" width="8%" align="center">Gratuity  Interest</td>
				<td class="label" width="8%" align="center">EPFO pension</td>
			...
			<%
				double totalEmoluments = 0.0, AdditionalContri = 0.0, BenfundContribution = 0.0, BenfundPension = 0.0, GratuityInterestThereon = 0.0, EpfoPension = 0.0, pfStaturary = 0.0, totalPension = 0.0, empVpf = 0.0, principle = 0.0, interest = 0.0, pfContribution = 0.0;
						double grandEmoluments = 0.0, grandCPF = 0.0, grandPension = 0.0, grandPFContribution = 0.0;
						double cpfInterest = 0.0, pensionInterest = 0.0, pfContributionInterest = 0.0, BenfundContributionIntrest = 0.0, BenfundPensionIntrest = 0.0, GratuityInterestThereonIntrest = 0.0, EpfoPensionIntrest = 0.0;
						double grandCPFInterest = 0.0, grandPensionInterest = 0.0, grandPFContributionInterest = 0.0;
						double cumPFStatury = 0.0, cumPension = 0.0, cumPfContribution = 0.0, cumBenfundContribution = 0.0, cumBenfundPension = 0.0, cumGratuityInterestThereon = 0.0, cumEpfoPension = 0.0;
						double cpfOpeningBalance = 0.0, penOpeningBalance = 0.0, pfOpeningBalance = 0.0, BenfundContributionOpeningBalance = 0.0, BenfundPensionIntrestOpeningBalance = 0.0, GratuityInterestThereonIntrestOpeningBalance = 0.0, EpfoPensionIntrestOpeningBalance = 0.0;
						...
						for (int j = 0; j < pensionList.size(); j++) {
							...
							if (bean != null) {
								...
								AdditionalContri = new Double(df
										.format(AdditionalContri
												+ Math.round((Double
														.parseDouble(bean
																.getAddContri())))))
										.doubleValue();
								BenfundContribution = new Double(
										df
												.format(BenfundContribution
														+ Math
																.round((Double
																		.parseDouble(bean
																				.getBenfundContri())))))
										.doubleValue();
								BenfundPension = new Double(
										df
												.format(BenfundPension
														+ Math
																.round((Double
																		.parseDouble(bean
																				.getBenfundPension())))))
										.doubleValue();
								GratuityInterestThereon = new Double(
										df
												.format(GratuityInterestThereon
														+ Math
																.round((Double
																		.parseDouble(bean
																				.getGratuityInterest())))))
										.doubleValue();
								EpfoPension = new Double(df.format(EpfoPension
										+ Math.round((Double.parseDouble(bean
												.getEpfoPension())))))
										.doubleValue();
								...
								cumPfContribution = cumPfContribution
										+ pfContribution;
								cumBenfundContribution = cumBenfundContribution
										+ BenfundContribution;
								cumBenfundPension = cumBenfundPension
										+ BenfundPension;
								cumGratuityInterestThereon = cumGratuityInterestThereon
										+ GratuityInterestThereon;
								cumEpfoPension = cumEpfoPension + EpfoPension;

								//	System.out.println(" getAdditionalContribution " + bean.getAdditionalContribution());
			%>
			...
			<tr> 
                ...
                <td class="Data" width="6%" align="right"><input type="text"
				 ...
				 <td class="Data" width="6%" align="right"><input type="text"
					readonly="true" onkeypress="numsDotOnly()" name="addContri<%=j%>" id="addContri<%=j%>"
					size="5"
					value='<%=bean.getAddContri()%>'/></td>
				...
				<td class="Data" width="6%" align="right"><input type="text"
					...
					size="5" value='<%=Math.round(Double.parseDouble(bean
												.getDbPensionCtr()))%>'/></td>
				<td class="Data" align="right"><%=Math.round(Double.parseDouble(bean
												.getAaiPFCont()))%></td>
				
				<td class="Data" width="6%" align="right"><input type="text"
					readonly="true" onkeypress="numsDotOnly()" name="benfundcontr<%=j%>" id="benfundcontr<%=j%>"
					size="5" value='<%=Math.round(Double.parseDouble(bean
												.getBenfundContri()))%>'/></td>
					
				<td class="Data" width="6%" align="right"><input type="text"
					readonly="true" onkeypress="numsDotOnly()" name="benfundPension<%=j%>" id="benfundPension<%=j%>"
					size="5" value='<%=Math.round(Double.parseDouble(bean
												.getBenfundPension()))%>'/></td>
					
				<td class="Data" width="6%" align="right"><input type="text"
					readonly="true" onkeypress="numsDotOnly()" name="gratuityInterest<%=j%>" id="gratuityInterest<%=j%>"
					size="5" value='<%=Math.round(Double.parseDouble(bean
												.getGratuityInterest()))%>'/></td>
					
				<td class="Data" width="6%" align="right"><input type="text"
					readonly="true" onkeypress="numsDotOnly()" name="epfoPension<%=j%>" id="epfoPension<%=j%>"
					size="5" value='<%=Math.round(Double.parseDouble(bean
												.getEpfoPension()))%>'/></td>
				...
				%>
													...
													<option value="1" <%if (noofMonths.equals("1")) {
									out.println("selected");
								}%>>
														one Month
													</option>
													<option value="0.5" <%if (noofMonths.equals("0.5")) {
									out.println("selected");
								}%>>
														half Month
													</option>
                                                    <option value="3" <%if (noofMonths.equals("3")) {
									out.println("selected");
								}%>>
														3 Days
													</option>
  													<option value="4" <%if (noofMonths.equals("4")) {
									out.println("selected");
								}%>>
														4 Days
													</option>
												<option value="5" <%if (noofMonths.equals("5")) {
									out.println("selected");
								}%>>
														5 Days
													</option>
                                                   <option value="6" <%if (noofMonths.equals("6")) {
									out.println("selected");
								}%>>
														6 Days
													</option>
  													<option value="7" <%if (noofMonths.equals("7")) {
									out.println("selected");
								}%>>
														7 Days
													</option>
												<option value="8" <%if (noofMonths.equals("8")) {
									out.println("selected");
								}%>>
														8 Days
													</option>
												<option value="9" <%if (noofMonths.equals("9")) {
									out.println("selected");
								}%>>
														9 Days
													</option>
													<option value="10" <%if (noofMonths.equals("10")) {
									out.println("selected");
								}%>>
														10 Days
													</option>
													 <option value="11" <%if (noofMonths.equals("11")) {
									out.println("selected");
								}%>>
														11 Days
													</option>
  													<option value="12" <%if (noofMonths.equals("12")) {
									out.println("selected");
								}%>>
														12 Days
													</option>
												<option value="13" <%if (noofMonths.equals("13")) {
									out.println("selected");
								}%>>
														13 Days
													</option>
                                                   <option value="14" <%if (noofMonths.equals("14")) {
									out.println("selected");
								}%>>
														14 Days
													</option>
  													<option value="15" <%if (noofMonths.equals("15")) {
									out.println("selected");
								}%>>
														15 Days
													</option>
												<option value="16" <%if (noofMonths.equals("16")) {
									out.println("selected");
								}%>>
														16 Days
													</option>
												<option value="17" <%if (noofMonths.equals("17")) {
									out.println("selected");
								}%>>
														17 Days
													</option>
													<option value="18" <%if (noofMonths.equals("18")) {
									out.println("selected");
								}%>>
														18 Days
													</option>
													<option value="19" <%if (noofMonths.equals("19")) {
									out.println("selected");
								}%>>
														19 Days
													</option>
													 <option value="20" <%if (noofMonths.equals("20")) {
									out.println("selected");
								}%>>
														20 Days
													</option>
  													<option value="21" <%if (noofMonths.equals("21")) {
									out.println("selected");
								}%>>
														21 Days
													</option>
												<option value="22" <%if (noofMonths.equals("22")) {
									out.println("selected");
								}%>>
														22 Days
													</option>
                                                   <option value="23" <%if (noofMonths.equals("23")) {
									out.println("selected");
								}%>>
														23 Days
													</option>
  													<option value="24" <%if (noofMonths.equals("24")) {
									out.println("selected");
								}%>>
														24 Days
													</option>
												<option value="25" <%if (noofMonths.equals("25")) {
									out.println("selected");
								}%>>
														25 Days
													</option>
												<option value="26" <%if (noofMonths.equals("26")) {
									out.println("selected");
								}%>>
														26 Days
													</option>
													<option value="27" <%if (noofMonths.equals("27")) {
									out.println("selected");
								}%>>
														27 Days
													</option>
													<option value="28" <%if (noofMonths.equals("28")) {
									out.println("selected");
								}%>>
														28 Days
													</option>						
													<option value="2" <%if (noofMonths.equals("2")) {
									out.println("selected");
								}%>>
														2 Months
													</option>
													 <option value="90" <%if (noofMonths.equals("90")) {
									out.println("selected");
								}%>>
														3 Months
													</option>
                                                     <option value="120" <%if (noofMonths.equals("120")) {
									out.println("selected");
								}%>>
														4 Months
													</option>
												 <option value="150" <%if (noofMonths.equals("150")) {
									out.println("selected");
								}%>>
														5 Months
													</option>
												<option value="180" <%if (noofMonths.equals("180")) {
									out.println("selected");
								}%>>
														6 Months
													</option>
											<option value="210" <%if (noofMonths.equals("210")) {
									out.println("selected");
								}%>>
														7 Months
													</option>
										<option value="240" <%if (noofMonths.equals("240")) {
									out.println("selected");
								}%>>
														8 Months
													</option>
										<option value="270" <%if (noofMonths.equals("270")) {
									out.println("selected");
								}%>>
														9 Months
													</option>
										<option value="300" <%if (noofMonths.equals("300")) {
									out.println("selected");
								}%>>
														10 Months
													</option>
<option value="330" <%if (noofMonths.equals("330")) {
									out.println("selected");
								}%>>
														11 Months
													</option>
<option value="360" <%if (noofMonths.equals("360")) {
									out.println("selected");
								}%>>
														12 Months
													</option>
<option value="390" <%if (noofMonths.equals("390")) {
									out.println("selected");
								}%>>
														13 Months
													</option>
<option value="420" <%if (noofMonths.equals("420")) {
									out.println("selected");
								}%>>
														14 Months
													</option>
<option value="450" <%if (noofMonths.equals("450")) {
									out.println("selected");
								}%>>
														15 Months
													</option>
       ...
       <td class="Data" width="7%" align="right"> <select name="arrearflag<%=j%>" id="arrearflag<%=j%>" disabled="disabled" style="width:30px" >
				...
				%>
													...
													<option value="N" <%if (arrearFlag.equals("N")) {
									out.println("selected");
								}%>>
														No
													</option>
													<option value="Y" <%if (arrearFlag.equals("Y")) {
									out.println("selected");
								}%>>
														Yes
													</option>
...
<td class="Data" width="6%" align="right"><input type="text"
				...
				<td class="Data" width="6%" align="right"><input type="text"
					...
					%>
							...
							<td class="Data"><input type="button" name="edit<%=j%>" id="edit<%=j%>" disabled="true"
					value="E" style = "cursor:hand;" 
					onclick="editEmoluments('<%=bean.getMonthyear()%>','<%=bean.getTransCpfaccno()%>','<%=bean.getRegion()%>','<%=bean.getStation()%>','<%=pensionNo%>','emoluments<%=j%>','vpf<%=j%>','principle<%=j%>','interest<%=j%>','advance<%=j%>','contr<%=j%>','advance<%=j%>','loan<%=j%>','aailoan<%=j%>','edit<%=j%>','<%=contr.getPfSettled()%>','<%=userId%>','<%=bean.getDataFreezFlag()%>','form7narration<%=j%>','pcheldamt<%=j%>','noofmonths<%=j%>','arrearFlag<%=j%>','<%=bean.getDeputationFlag()%>','epf<%=j%>','benfundcontr<%=j%>','benfundPension<%=j%>','gratuityInterest<%=j%>','epfoPension<%=j%>','addContri<%=j%>')" /></td>
					<%} else { %> 
			...
			<tr>
				...
				<td class="HighlightData" align="right"><%=df.format(AdditionalContri)%></td>								
				...
				<td class="HighlightData" align="right"><%=df.format(BenfundContribution)%></td>
				<td class="HighlightData" align="right"><%=df.format(BenfundPension)%></td>
				<td class="HighlightData" align="right"><%=df.format(GratuityInterestThereon)%></td>
				<td class="HighlightData" align="right"><%=df.format(EpfoPension)%></td>
				...
				<td class="HighlightData" align="right" colspan="12">&nbsp;  </td>
			...
			<tr>
				<%
					cpfInterest = Math.round((cumPFStatury
										...
										BenfundContributionIntrest = Math
												.round((cumBenfundContribution
														* rateOfInterest / 100) / 12)
												+ Math
														.round(BenfundContributionOpeningBalance
																* rateOfInterest / 100);
										BenfundPensionIntrest = Math
												.round((cumBenfundPension
														* rateOfInterest / 100) / 12)
												+ Math
														.round(EpfoPensionIntrestOpeningBalance
																* rateOfInterest / 100);
										GratuityInterestThereonIntrest = Math
												.round((cumGratuityInterestThereon
														* rateOfInterest / 100) / 12)
												+ Math
														.round(EpfoPensionIntrestOpeningBalance
																* rateOfInterest / 100);
										EpfoPensionIntrest = Math.round((cumEpfoPension
												* rateOfInterest / 100) / 12)
												+ Math
														.round(EpfoPensionIntrestOpeningBalance
																* rateOfInterest / 100);
				...
				<td class="HighlightData" align="right"><%=df
														.format(BenfundContributionIntrest)%></td>
				<td class="HighlightData" align="right" ><%=df
														.format(BenfundPensionIntrest)%></td>
				<td class="HighlightData" align="right"><%=df
														.format(GratuityInterestThereonIntrest)%></td>
				<td class="HighlightData" align="right"><%=df.format(EpfoPensionIntrest)%></td>
				<td class="HighlightData" align="right" colspan="12">&nbsp;    </td>
			</tr>
			<tr>
				<%
					flag = false;
										...
										pfOpeningBalance = Math.round(pfContribution
												...
												+ Math.round(pfOpeningBalance));
										BenfundContributionOpeningBalance = Math
												.round(BenfundContribution
														+ BenfundContributionIntrest
														+ Math
																.round(BenfundContributionOpeningBalance));

										BenfundPensionIntrestOpeningBalance = Math
												.round(BenfundPension
														+ BenfundPensionIntrest
														+ Math
																.round(BenfundContributionOpeningBalance));

										GratuityInterestThereonIntrestOpeningBalance = Math
												.round(GratuityInterestThereon
														+ GratuityInterestThereonIntrest
														+ Math
																.round(GratuityInterestThereonIntrestOpeningBalance));

										EpfoPensionIntrestOpeningBalance = Math
												.round(EpfoPension
														+ EpfoPensionIntrest
														+ Math
																.round(EpfoPensionIntrestOpeningBalance));
				...
				<td class="HighlightData" align="right" ><%=df
														.format(BenfundContributionOpeningBalance)%></td>
				<td class="HighlightData" align="right" ><%=df
														.format(BenfundPensionIntrestOpeningBalance)%></td>
				<td class="HighlightData" align="right" ><%=df
														.format(GratuityInterestThereonIntrestOpeningBalance)%></td>
				<td class="HighlightData" align="right" ><%=df
														.format(EpfoPensionIntrestOpeningBalance)%></td>
				<td class="HighlightData" align="right" colspan="14">&nbsp;   </td>
			...
			<%
				if (finalStatus.equals("Yes")) {
										CadService cs = new CadService();
										System.out
												.println("insert method call================================== empSerialNo "
														+ empSerialNo
														+ " totalYear "
														+ totalYear
														+ " totalEmoluments "
														+ totalEmoluments);
										cs.insertCadAllYear(empSerialNo, totalYear,
												Double.toString(totalEmoluments),
												Double.toString(pfStaturary),
												Double.toString(AdditionalContri),
												Double.toString(empVpf), Double
														.toString(cpfInterest),
												Double.toString(pensionInterest),
												Double.toString(totalPension));
										System.out
												.println("insert method call==================================");
									}
									...
									BenfundContribution = 0;
									BenfundPension = 0;
									GratuityInterestThereon = 0;
									EpfoPension = 0;
								}
			%>
			<%
