...
public class UserService {
	...
	public ArrayList getUserNames(String username) throws Exception {
		ArrayList al = UserDAO.getUserNames(username);
		return al;
	}
...
/*	public ArrayList getDetails(UserBean bean) throws Exception {
	...
	public UserBean checkUser(String username, String password,String ipaddress,String usertype) throws InvalidDataException  {
		...
		return  UserDAO.checkUser(username, password,ipaddress,usertype);
	}
...
public String forgotpassword(String userName,String doj)throws Exception {
	return UserDAO.forgotpassword(userName,doj);
}
public void updateAccessRight(String userName,String[] accessrights)throws Exception{
	UserDAO.updateAccessRight(userName, accessrights);
	}
