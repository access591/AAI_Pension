...
protected void doPost(HttpServletRequest request,
	...
	try {
		...
		String query="select pensionno,(select o.emailid from employee_personal_info o where o.pensionno=s.pensionno) as emailid from epis_pfcard_mailstatus s where  s.mailstatus='N' ";
		...
		//this.PFcardBulkMail("/reportservlet?method=SumofSuppPCReport&frm_Name=SumofSuppPCReport&employeeNo=4245&reportType=html","D:/kk.pdf/",session,"4245.pdf",null,"","","","","","","");
		this.PFcardBulkMail("/reportservlet?method=cardReport&frm_region=AllRegions&frm_year=2020&frm_reportType=Html&frm_empnm=emp&frm_emp_flag=true&frm_pensionno="+pensionno+"&frm_pfids=NO-SELECT&sortingOrder=&frm_ltstmonthflag=&transMonthYear=&frmAirportCode=&frm_blkprintflag=true&mailStatus=true","D:/PFCards_2020-21/",session,pensionno+".pdf",con,mailid,"","","","",pensionno,"");
		pensionno="";
		}
	} catch (Exception e) {
...
public   Map  PFcardBulkMail(String reportName,String pdfpath ,HttpSession session,String rpath,Connection con,String mailpropspath,String billNo,String contractorCd,String billType,String billDate,String pensionno,String fromEmailID)  throws Exception{
    ...
    try {
    	...
    	map=doConversion(reportName, pdfpath,session,rpath,con,mailpropspath,billNo,contractorCd,billType,billDate,pensionno,fromEmailID);
    } catch (Exception e) {
        e.printStackTrace();
    }
    return map;
...
public  Map  doConversion(String url, String pdfpath,HttpSession session,String rpath,Connection con,String mailpropspath,String billNo,String contractorCd,String billType,String billDate,String pensionno,String fromEmailID) 
    throws Exception {
...
//System.out.println("pdfffffff method111111111111"+url); 
  //local devlopment       
url="http://nit527:82"+url;
    //url="http://172.16.11.126"+url;
  ...
  // System.out.println("pdfffffff method111111111111"+url);
   ...
   System.out.println("2222222");
    ...
    //System.out.println("11111111111");
     map=setBody(subject, contractorCd, billType, billNo, path, billDate,con, mailpropspath,null,pensionno,fromEmailID) ;
...
public Map setBody(String subject,String contractorCd,String billType,String billNo,String path,String billdate,Connection con,String mailpropspath,HttpSession session,String pensionno,String fromEmailID) throws Exception {
...
*/
	...
	fromEmailID="no-reply-pfcard@aai.aero";
  
	/** Changed mail heading 'Commercial' to 'AAI' By Srilakshmi 21/08/08 */
	InternetAddress add=new InternetAddress(fromEmailID,"EPIS-PF Card");
...
//System.out.println("AIRPORT_TYPE:--"+rs.getString("AIRPORT_TYPE"));
		 ...
		 if(rs != null){
			...
			String htmlText = "<table><tr><td><font face='arial'>Dear Sir/Madam,<br><br>Please find attached your PF Card eStatement for Fin year 2020-2021.<BR>"+"<BR><BR>Best Regards<BR><BR>EPIS SUPPORT<BR><BR></font></td></tr>";
		  ...
		  if(!subject.startsWith("StationAgeWiseOutstanding")) 			
			...
			bodyPart2.setFileName(pensionno+".pdf"); 
	 ...
	 /*if("AgeWise".equals(billType))
		 checkmail=mail;
	*/if(mailstaus.equals("Success")){
		statusCode="Y";
	}else{
		statusCode="P";
	}
	Statement st1=con.createStatement();
	st1.executeUpdate("update epis_pfcard_mailstatus s set s.mailstatus='"+statusCode+"' where pensionno="+pensionno);
